...
#IMPORTANT NOTE: DOES NOT HANDLE SPLICED SEQUENCES! (i.e. curly brackets)
#NEED TO UPDATE THE CODE FOR THAT (DEVELOPED ON S1 bZIPS WHICH ARE INTRONLESS)
...
if len(sys.argv) not in [2,3]:
	...
	print '	 - hits aligned regions fasta file, DNA'
	print '	 - hits aligned regions fasta file, PROTEIN'	
	print 
