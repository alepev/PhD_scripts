...
#output file (counts + p-values, if background given)
	...
	print
	print '#unique RNA coordinates passing filtering:\t',Nrna
	print '#(total allowing identical coordinates):\t',Rnames
	print 
	...
	if not FISHER:
		...
		print 
		print '#N protein-coding genes with RNA structure overlapping exon feature (RNA partially/FULLY contained in gene limits)'
		print '5UTR\t',c5,'\t',c5f
		print '3UTR\t',c3,'\t',c3f
		print 'CDS\t',cCDS,'\t',cCDSf
		print 'exon\t',cEX,'\t',cEXf
		print
		print '#N protein-coding genes with RNA structure not overlapping exon feature (RNA partially/FULLY contained in gene limits)'
		print 'intron\t',cIN,'\t',cINf
		print
		print '#N protein-coding genes with RNA structure FULLY CONTAINED IN EXON FEATURE LIMITS'
		...
		print 
		print '#N protein-coding genes with RNA structure overlapping exon feature (RNA partially contained in gene limits)'
		...
		print
		print '#N protein-coding genes with RNA structure overlapping exon feature (RNA FULLY contained in gene limits)'
		...
		print
		print '#N protein-coding genes with RNA structure not overlapping exon feature (RNA partially contained in gene limits)'
		print 'intron\t',cIN,'\t',BKG['intron'],'\t',FoldEn['INpval'][0],'\t',FoldEn['INpval'][1]
		print
		print '#N protein-coding genes with RNA structure not overlapping exon feature (RNA FULLY contained in gene limits)'
